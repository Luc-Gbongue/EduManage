    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="pages/students.php">Elèves</a></li>
                <li><a href="pages/grades.php">Notes</a></li>
        ...
        <section class="dashboard-content">
            ...
            <section class="dashboard-card">
                <div class="dashboard-box">
                    ...
                    <a href="pages/students.php" class="action-btn">Ajouter un élève</a>
                </div>
                <div class="dashboard-box">
                    <h2>Gestion des notes</h2>
                    <img src="images/Gestion_notes.jpg" alt="notes">
                    <a href="pages/grades.php" class="action-btn">Ajouter une note</a>
                </div>
            </section>
        </section>
